...
### Step 5: `/tasks-refine`
Takes a feature ID as an inline argument (e.g. `/tasks-refine F01`), then prompts interactively for the refinement request. Applies the changes to that feature's task list.
...
# Readme 
* Include an excellent, open-source worthy readme in j2 itself
* When j2 deploys an application it will now be used in a similar way
* Whenever the /milestone command is issued a readme.md is created or updated
* It should be open-source worthy
